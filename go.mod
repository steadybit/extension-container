...
require (
	...
	github.com/steadybit/action-kit/go/action_kit_commons v1.0.9
	...
	github.com/steadybit/discovery-kit/go/discovery_kit_sdk v1.0.3-0.20231129123841-9e33f8f01107

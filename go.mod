...
require (
	...
	github.com/steadybit/action-kit/go/action_kit_api/v2 v2.10.1
	github.com/steadybit/action-kit/go/action_kit_commons v1.5.8-0.20251027151519-2c38d200fdc8

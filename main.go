...
func main() {
	...
	runc := runc.Runc{Root: client.Runtime().DefaultRuncRoot()}
	...
	action_kit_sdk.RegisterAction(extcontainer2.NewStressCpuContainerAction(client, runc))
	action_kit_sdk.RegisterAction(extcontainer2.NewStressMemoryContainerAction(client, runc))
	action_kit_sdk.RegisterAction(extcontainer2.NewStressIoContainerAction(client, runc))

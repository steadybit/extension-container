...
func testNetworkBlackhole(t *testing.T, m *Minikube, e *Extension) {
	pod, err := createNginxPod(m, "nginx-blackhole")
	require.NoError(t, err, "failed to create pod")
	defer func() { _ = deletePod(m, pod) }()

	status, err := getContainerStatus(m, pod, "nginx")
	...
	exec := e.RunAction("com.github.steadybit.extension_container.container.network_blackhole", target, config)
...
func testStressCpu(t *testing.T, m *Minikube, e *Extension) {
	...
	exec := e.RunAction("com.github.steadybit.extension_container.container.stress_cpu", target, config)
...
func testStressMemory(t *testing.T, m *Minikube, e *Extension) {
	...
	exec := e.RunAction("com.github.steadybit.extension_container.container.stress_mem", target, config)
...
func testStressIo(t *testing.T, m *Minikube, e *Extension) {
	...
	exec := e.RunAction("com.github.steadybit.extension_container.container.stress_io", target, config)

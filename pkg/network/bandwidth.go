...
func (o *BandwidthOpts) IpCommands(_ Family, _ Mode) (io.Reader, error) {
	return nil, nil
}

func (o *BandwidthOpts) TcCommands(mode Mode) (io.Reader, error) {
	var cmds []string
...
func (o *BandwidthOpts) String() string {
